...
return [
    ...
    'timestamp' => 1724381679,
    'checksum' => 'dcec1a5dcfcdc0a0d57f28d22e6e05ae',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/productfetcher' => [
                'file' => 'user/plugins/productfetcher/blueprints.yaml',
                'modified' => 1724381477
            ]
        ],
        'user/themes' => [
            'themes/product-theme' => [
                'file' => 'user/themes/product-theme/blueprints.yaml',
                'modified' => 1724304468
            ],
            'themes/quark' => [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.productfetcher.enabled' => [
                'type' => 'toggle',
                'label' => 'Plugin status',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'plugins.productfetcher.enabled',
                'validation' => 'loose'
            ],
            'themes.product-theme' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'productfetcher' => [
                    'enabled' => 'plugins.productfetcher.enabled'
                ]
            ],
            'themes' => [
                'product-theme' => 'themes.product-theme',
                'quark' => [
